...
__global__ void densityReinitialization(fluid f, solid s, interactionBase fluid2Fluid, interactionBase fluid2Solid, int iStep);
...
__global__ void calDummyParticlePressure(solid s, fluid f, interactionBase fluid2Solid, double3 g);
...
__global__ void calInfiniteWallForceTorque(solid s, interactionSolid2InfiniteWall solid2InfiniteWall, infiniteWall infiniteWalls, solidContactModel contactModels, double dt);

__global__ void calCylinderWallForceTorque(solid s, interactionSolid2InfiniteWall solid2CylinderWall, cylinderWall cylinderWalls, solidContactModel contactModels, double dt);
